...
class _netD(nn.Module):
    ...
    def forward(self, input,isQ = False):
        output = self.main(input)
...
plt.ylabel('loss')
plt.plot(np.arange(1,len(loss_listG)+1),loss_listD , color = 'blue',label='G')
plt.plot(np.arange(1,len(loss_listD)+1),loss_listG , color = 'red',label='D')
plt.plot(np.arange(1,len(loss_listQ)+1),loss_listQ , color = 'green',label='Q')
...
plt.plot(np.arange(1,len(D_x_list)+1),D_x_list , color = 'blue',label='D_x')
plt.plot(np.arange(1,len(D_G1_list)+1),D_G1_list , color = 'red',label='D_G1')
plt.plot(np.arange(1,len(D_G2_list)+1),D_G2_list , color = 'green',label='D_G2')
plt.legend(loc='upper right')
